...
var totalInvoicesChart = new Chart(totalInvoices, {
	type: 'line',
	data: {
...
// Paid Invoices
var paidInvoices = $('#paidInvoices');
var paidInvoicesChart = new Chart(paidInvoices, {
	type: 'line',
	data: {
		labels: ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5', 'Day 6', 'Day 7'],
		datasets: [{
...
// Overdue Invoices
var overdueInvoices = $('#overdueInvoices');
var overdueInvoicesChart = new Chart(overdueInvoices, {
	type: 'line',
	data: {
		labels: ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5', 'Day 6', 'Day 7'],
		datasets: [{
